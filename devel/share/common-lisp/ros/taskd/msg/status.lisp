...
(cl:defmethod cl:initialize-instance :after ((m <status>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'status)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name taskd-msg:<status> is deprecated: use taskd-msg:status instead.")))
...
(cl:defmethod finished-val ((m <status>))
